...
function App() {
  ...
  return (
    ...
    <header className="header">
        <div className="container navbar-container">
            ...
            <nav className="nav-menu" id="navMenu">
                ...
                <a href="https://wa.me/919629141957?text=Hi%20Karthick,%20I%27m%20interested%20in%20a%20home%20interior%20consultation."
                    ...
                    <div className="owner-highlight">
                        ...
                        <div className="owner-info">
                            <div className="owner-meta">
                                <span className="owner-name">GP Karthick</span>
                ...
                <div className="service-card animate-on-scroll tilt-card" data-aos="fade-up" data-aos-delay="100">
                    <div className="service-img-holder">
                        ...
                        <img src="interior%20image/WhatsApp%20Image%202026-07-14%20at%2009.24.39%20(3).jpeg"
                            alt="Modular Kitchen" loading="lazy" />
                    </div>
                    <div className="service-details">
                        <span className="service-num">01</span>
                        <h3>Modular Kitchens</h3>
                        <p>Premium L-shaped, U-shaped and parallel kitchen layouts with termite-free cabinetry,
                            heat-resistant finishes, and whisper-soft soft-close sliding mechanisms. Custom designed to
                            maximize space and functionality.</p>
                    </div>
                </div>
    ...
    <section id="designs" className="gallery section-padding bg-light" data-aos="fade-up">
        <div className="container">
            ...
            <div className="gallery-grid" id="galleryGrid">
                {/* Image 1 */}
                <div className="gallery-item kitchen" data-index="0" data-aos="scale-up" data-aos-delay="100"
                    data-src="interior%20image/WhatsApp%20Image%202026-07-14%20at%2009.24.39.jpeg"
                    data-title="Modern Modular Kitchen"
                    data-desc="A modern modular kitchen featuring elegant cabinetry, efficient storage, premium finishes, and a functional layout designed for everyday convenience.">
                    <div className="premium-card">
                        <div className="premium-card-img-wrapper">
                            <img src="interior%20image/WhatsApp%20Image%202026-07-14%20at%2009.24.39.jpeg"
                                alt="Modern Modular Kitchen" className="lazy-load" loading="lazy" />
                            <div className="gallery-overlay">
                                <h4>Modern Modular Kitchen</h4>
                        ...
                        <div className="gallery-details-card premium-card-content">
                            ...
                            <h4 className="premium-title">Modern Modular Kitchen</h4>
                            <p className="premium-desc">A modern modular kitchen featuring elegant cabinetry, efficient storage, premium finishes, and a functional layout designed for everyday convenience.</p>
                            <a href="https://wa.me/919629141957?text=Hi,%20I%20am%20interested%20in%20booking%20the%20Modern%20Modular%20Kitchen%20design."
                ...
                {/* Image 4 */}
                <div className="gallery-item bedroom" data-index="3" data-aos="scale-up" data-aos-delay="100"
                    data-src="interior%20image/WhatsApp%20Image%202026-07-14%20at%2009.24.38.jpeg"
                    data-title="Modern Luxury Bedroom"
                    data-desc="A sophisticated modern bedroom featuring elegant wood finishes, a stylish bed backdrop, warm ambient lighting, comfortable furniture, and carefully coordinated interior elements for a luxurious and relaxing atmosphere.">
                    <div className="premium-card">
                        <div className="premium-card-img-wrapper">
                            <img src="interior%20image/WhatsApp%20Image%202026-07-14%20at%2009.24.38.jpeg"
                                alt="Modern Luxury Bedroom" className="lazy-load" loading="lazy" />
                            <div className="gallery-overlay">
                        ...
                        <div className="gallery-details-card premium-card-content">
                            ...
                            <h4 className="premium-title">Modern Luxury Bedroom</h4>
                            <p className="premium-desc">A sophisticated modern bedroom featuring elegant wood finishes, a stylish bed backdrop, warm ambient lighting, comfortable furniture, and carefully coordinated interior elements for a luxurious and relaxing atmosphere.</p>
                            <a href="https://wa.me/919629141957?text=Hi,%20I%20am%20interested%20in%20booking%20the%20Modern%20Luxury%20Bedroom%20design."
                                target="_blank" className="btn btn-primary premium-card-btn">BOOK NOW</a>
                        </div>
                    </div>
                </div>
    ...
    <div className="lightbox" id="lightbox">
        ...
        <div className="lightbox-content">
            ...
            <div className="lightbox-details">
                ...
                <a href="https://wa.me/919629141957?text=Hi%20Karthick,%20I'm%20interested%20in%20a%20design%20similar%20to%20"
    ...
    <section className="testimonials section-padding" data-aos="fade-up">
        <div className="container">
            <div className="text-center mb-50">
            ...
            <div className="testimonials-slider" id="testimonialSlider">
                <div className="testimonials-track" id="testimonialTrack">
                    {/* Slide 1 */}
                    <div className="testimonial-slide">
                        <div className="testimonial-card">
                            <div className="stars">★ ★ ★ ★ ★</div>
                            <p className="review-text">
                                "Sastikeyan Interior converted our 3BHK house into a beautiful home. GP Karthick's
                                design
                                suggestions for the modular kitchen were excellent. Very satisfied with the finishing."
                            </p>
                        ...
                        <div className="testimonial-card">
                            <div className="stars">★ ★ ★ ★ ★</div>
                            <p className="review-text">
                                "Amazing wardrobe designs with a clean high-gloss finish. The sliding mechanism works
                                perfectly.
                                Karthick was present personally to monitor the installation. Fully recommend
                                Sastikeyan!"
                            </p>
                            <div className="reviewer">
                                <div className="rev-details">
                                    <strong>Meenakshi S.</strong>
                                    <span>Trichy, TN</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="testimonial-card">
                            <div className="stars">★ ★ ★ ★ ★</div>
                            <p className="review-text">
                                "Most reliable interior services. Friendly approach, transparent budgets, and strictly
                                followed
                                timelines. The false ceiling and ambient lights completely changed our living room
                                vibe."
                            </p>
                            <div className="reviewer">
                                <div className="rev-details">
                                    <strong>Anwar Hussain</strong>
                    ...
                    <div className="testimonial-slide">
                        <div className="testimonial-card">
                            <div className="stars">★ ★ ★ ★ ★</div>
                            <p className="review-text">
                                "GP Karthick and team did an outstanding job with our office interiors. The modern
                                workstations and
                                cabin partitions exceeded our expectations. Highly professional!"
                            </p>
                            <div className="reviewer">
                                <div className="rev-details">
                                    <strong>Vikram Rajan</strong>
                                    <span>Chennai, TN</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="testimonial-card">
                            <div className="stars">★ ★ ★ ★ ★</div>
                            <p className="review-text">
                                "We hired Sastikeyan for our new home's complete interiors. From the pooja room to the
                                modular kitchen,
                                every detail was handled with utmost care. Truly bespoke!"
                            </p>
                            <div className="reviewer">
                                <div className="rev-details">
                        ...
                        <div className="testimonial-card">
                            <div className="stars">★ ★ ★ ★ ★</div>
                            <p className="review-text">
                                "The false ceiling design with ambient lighting transformed our living room completely.
                                Karthick's team was punctual and delivered exactly as promised. Great value!"
                            </p>
                            <div className="reviewer">
                                <div className="rev-details">
                    ...
                    <div className="testimonial-slide">
                        <div className="testimonial-card">
                            <div className="stars">★ ★ ★ ★ ★</div>
                            <p className="review-text">
                                "Excellent work on our modular kitchen and wardrobes. The soft-close mechanisms and
                                the finish quality are top-notch. Would definitely recommend to friends and family."
                            </p>
                            <div className="reviewer">
                                <div className="rev-details">
                                    <strong>Lakshmi N.</strong>
                                    <span>Vellore, TN</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="testimonial-card">
                            <div className="stars">★ ★ ★ ★ ★</div>
                            <p className="review-text">
                                "Sastikeyan Interior brought our dream home to life. The TV unit wall panel and the
                                bedroom wardrobe designs are simply stunning. Thank you, Karthick!"
                            </p>
                            <div className="reviewer">
                                <div className="rev-details">
                                    <strong>Arun Prasad</strong>
                        ...
                        <div className="testimonial-card">
                            <div className="stars">★ ★ ★ ★ ★</div>
                            <p className="review-text">
                                "Professional, transparent, and creative. GP Karthick listened to our needs and
                                delivered
                                beyond expectations. The project was completed on time and within budget."
                            </p>
                            <div className="reviewer">
                                <div className="rev-details">
                                    <strong>Farhana Begum</strong>
                                    <span>Chennai, TN</span>
                                </div>
                            </div>
                        </div>
            ...
            <div className="testimonial-nav">
                <button className="testimonial-nav-btn" id="testimonialPrev"
                ...
                <button className="testimonial-nav-btn" id="testimonialNext"
    ...
    <div className="section-divider section-divider--bottom" style={{background: 'var(--color-light-bg)'}}>
        <svg viewBox="0 0 1200 80" preserveAspectRatio="none">
            <path d="M0,40 C300,80 600,0 1200,40 L1200,80 L0,80 Z" fill="var(--color-light-bg)" />
        </svg>
    </div>
            ...
            <div className="grid grid-2">
                ...
                <div className="contact-info-panel" data-aos="fade-right">
                    ...
                    <p className="text-muted mb-30">
                        ...
                        consultation today. Share your ideas with GP Karthick.
                    </p>
                    ...
                    <div className="contact-details-list">
                        ...
                        <div className="contact-item">
                            ...
                            <div className="contact-desc">
                                <span>WhatsApp Owner (GP Karthick)</span>
                                <strong><a
                                        href="https://wa.me/919629141957?text=Hi%20Karthick,%20I'm%20interested%20in%20discussing%20my%20home%20interiors."
    ...
    <footer className="footer">
            ...
            <div className="grid footer-grid">
                <div className="footer-about">
                    ...
                    <p className="footer-desc">
                        ...
                        commercial interior spaces. Owned and managed by GP Karthick.
                    </p>
                ...
                <div className="footer-hours">
                    ...
                    <ul>
                        ...
                        <li><span>Consulting Partner:</span> <strong>GP Karthick (Founder)</strong></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div className="footer-bottom">
            <div className="container flex-between">
                <p>&copy; 2026 Sastikeyan Interior. All Rights Reserved. Owned by GP Karthick.</p>
    ...
    <a href="https://wa.me/919629141957?text=Hi%20Karthick,%20I%20am%20interested%20in%20doing%20interior%20work%20for%20my%20property.%20Let%27s%20discuss!"
